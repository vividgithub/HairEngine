...
void validSolverCorretness() {
	const float simulationTimeStep = 1.0f / 120.0f; // The time interval for dumping a frame
	...
	const auto hair = make_shared<Hair>(Hair(R"(C:\Users\VividWinPC1\Developer\Project\HairEngine\Houdini\Resources\Models\Feamle 04 Retop\Hair\Curly-50000-p25.hair)").resample(5432));
